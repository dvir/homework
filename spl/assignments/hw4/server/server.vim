...
silent only
cd ~/homework/spl/assignments/hw4/server
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 Server.java
badd +2 ServerConcurrencyModel.java
badd +3 ThreadPerClient.java
badd +0 SingleThread.java
badd +0 ThreadPool
badd +0 ThreadPool.java
badd +4 MessageTokenizer.java
badd +9 ConnectionHandler.java
badd +26 MessagingProtocol
badd +5 MessagingProtocol.java
badd +18 Tokenizer.java
badd +0 Encoder.java
badd +0 SimpleEncoder.java
badd +18 LinePrintingProtocol.java
badd +0 User.java
badd +0 Channel.java
badd +0 IRCProtocol.java
badd +0 Event.java
args Server.java
edit ConnectionHandler.java
...
let s:l = 57 - ((36 * winheight(0) + 22) / 45)
...
30
normal! 0
tabedit MessagingProtocol.java
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 44 + 85) / 170)
exe 'vert 2resize ' . ((&columns * 125 + 85) / 170)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 89 - ((8 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
89
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 59 - ((4 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 84 - ((42 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
84
...
exe 'vert 1resize ' . ((&columns * 84 + 85) / 170)
exe 'vert 2resize ' . ((&columns * 85 + 85) / 170)
tabedit ServerConcurrencyModel.java
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
