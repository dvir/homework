...
exe 'vert 2resize ' . ((&columns * 53 + 102) / 205)
exe '3resize ' . ((&lines * 37 + 29) / 58)
exe 'vert 3resize ' . ((&columns * 78 + 102) / 205)
exe '4resize ' . ((&lines * 18 + 29) / 58)
exe 'vert 4resize ' . ((&columns * 53 + 102) / 205)
exe '5resize ' . ((&lines * 18 + 29) / 58)
exe 'vert 5resize ' . ((&columns * 53 + 102) / 205)
exe '6resize ' . ((&lines * 18 + 29) / 58)
exe 'vert 6resize ' . ((&columns * 72 + 102) / 205)
exe '7resize ' . ((&lines * 18 + 29) / 58)
exe 'vert 7resize ' . ((&columns * 72 + 102) / 205)
exe '8resize ' . ((&lines * 18 + 29) / 58)
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 160 - ((9 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
160
