...
maxcors:        equ 128         ; maximum number of co-routines
stacksz:        equ (128*4)     ; per-co-routine stack size
...
init_co:
        ...
        imul eax, ebx, stacksz  ; eax = co-routine's stack offset in stacks
        lea eax, [stacks + eax + stacksz] ; eax = top of (empty) co-routine's stack
