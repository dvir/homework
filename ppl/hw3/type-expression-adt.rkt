...
;Type:  Clients view: [T -> Boolean]
;       Implementation view: [LIST union Symbol -> Boolean]
;Purpose: is polymorphic te
;Tests: (polymorphic? (make-proc-te (make-tuple-te (list 'Number)) 'T1)) ==> #t
(define polymorphic? 
 (lambda(te) 
