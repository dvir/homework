...
(define (while-tests)
  (test (derive-analyze-eval '(begin (define evegeny-n (box 0)) (while (> (unbox evegeny-n) 0) (set-box! evegeny-n (- (unbox evegeny-n) 1))) (unbox evegeny-n))) => 0)
  )

(define (repeat-tests)
  (test (derive-analyze-eval '(begin (define evegeny-n (box 0)) (repeat (set-box! evegeny-n (- (unbox evegeny-n) 1)) (> (unbox evegeny-n) 0)) (unbox evegeny-n))) => -1)
  )
